...
def merge_paragraphs_3_90_91():
    ...
    if not p90 or not p91:
        print("Could not find paragraph 90 or 91. Maybe already merged?")
        return
        
    # Merge 90 and 91
    merged_p = {
        'num': 90,
        'german': p90['german'] + p91['german'],
        'english': p90['english'] + p91['english'],
        'korean': p90['korean'] + p91['korean'],
        'ai': p90['ai'] + p91['ai']
    }
    ...
    print(f"Successfully merged paragraph 90 & 91. New paragraph count: {len(new_paragraphs)}")

if __name__ == "__main__":
    merge_paragraphs_3_90_91()
