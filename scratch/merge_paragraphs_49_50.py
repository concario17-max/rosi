...
def merge_paragraphs_49_50():
    ...
    if not p49 or not p50:
        print("Could not find paragraph 49 or 50. Maybe already merged?")
        return
        
    # Merge 49 and 50. Join with a space or newline? Let's check how they were originally formatted.
    # We can separate them with a space, but since they are distinct terms, maybe a space is standard.
    merged_p = {
        'num': 49,
        'german': p49['german'] + p50['german'],
        'english': p49['english'] + p50['english'],
        'korean': p49['korean'] + p50['korean'],
        'ai': p49['ai'] + p50['ai']
    }
    ...
    output_lines.append("")
    output_lines.append("※ 2강 전체 80문단을 기준으로 재검수했습니다.")
    ...
    print(f"Successfully merged paragraph 49 & 50. New paragraph count: {len(new_paragraphs)}")

if __name__ == "__main__":
    merge_paragraphs_49_50()
